...
namespace SpaceTraffic.GameUi.Controllers
{
    ...
    public class StarSystemController : AbstractController
    {
        ...
        [HttpGet]
        // id: startSystem
        public JsonResult GetStarSystemObjects(string id)
        {
            DebugEx.Entry(id);
            ...
            IList<String> data = GSClient.GameService.GetStarSystemObjects(id);
            JsonResult result = Json(data, JsonRequestBehavior.AllowGet);
        ...
        [HttpGet]
        // id: startSystem;planet
        public JsonResult GetBase(String id)
        {
            String[] field = id.Split(';');
            Entities.Base data = GSClient.GameService.GetBase(field[0], field[1]);
            JsonResult result = Json(data, JsonRequestBehavior.AllowGet);
            return result;
        }

        [HttpGet]
        public JsonResult GetBases(string id)
        {
            DebugEx.Entry(id);
            ...
            IList<Entities.Base> data = GSClient.GameService.GetBasesIn(id);
            JsonResult result = Json(data, JsonRequestBehavior.AllowGet);
        ...
        [HttpGet]
        public JsonResult GetSpaceShips(string id)
        {
            DebugEx.Entry(id);
            ...
            IList<Entities.SpaceShip> data = GSClient.GameService.GetSpaceShipsIn(id);
            JsonResult result = Json(data, JsonRequestBehavior.AllowGet);
