...
namespace SpaceTraffic.Game
{
	...
	public struct CelestialObjectInfo
	{
		...
		/// <summary>
		/// Returns if this object has a base
		/// </summary>
		/// <value>
		/// Has this object a base?
		/// </value>
		public bool hasBase
		{
			get { return _hasBase; }
			set { this._hasBase = value; }
		}
		...
		public CelestialObjectInfo(double gravity, double mass, string description, bool hasBase) : this(gravity, mass, description)
		{
