...
namespace SpaceTraffic.GameServer
{
    public class TrafficManager
    {
        ...
        public static bool createTrafficManager(List<IPlanet> planets, List<IGoods> goodsList) {
            if (instance == null)
            {
        ...
        private void GenerateGoodsOnPlanets(List<IGoods> goodsList)
        {
            ...
            foreach (Planet planet in planets)
            {
                ...
                planet.GoodsPlanetList = planetGoodsList;
            }
        }

        public void BuyGoods(List<PlanetGoods> buyGoodsList, IPlanet _planet, SpaceShip spaceShip)
        {
            //nalezeni planety z ktereho se nakupuje
            foreach (Planet planet in planets) 
            {
                if (planet == _planet) {
                    ...
                    {
                        foreach (PlanetGoods goodsPlanet in planet.GoodsPlanetList)
                        {
