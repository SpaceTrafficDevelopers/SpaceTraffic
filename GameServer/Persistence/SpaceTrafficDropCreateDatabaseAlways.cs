...
{
    internal class SpaceTrafficDropCreateDatabaseAlways : IDatabaseInitializer<SpaceTrafficContext>
    {
        private string scriptPath;

        public SpaceTrafficDropCreateDatabaseAlways(string scriptPath)
        {
