 ...
 namespace SpaceTraffic.Persistence
{
    ...
    public class TraderCargoConfiguration : EntityTypeConfiguration<TraderCargo>
    {
            ...
            : base()
        {
            ...
            Property(p => p.CargoCount).HasColumnType("int").IsRequired();
            Property(p => p.CargoBuyPrice).HasColumnType("int").IsRequired();
            Property(p => p.CargoSellPrice).HasColumnType("int").IsRequired();
            Property(p => p.DailyConsumption).HasColumnType("int").IsRequired();
            Property(p => p.DailyProduction).HasColumnType("int").IsRequired();
            Property(p => p.TodayConsumed).HasColumnType("int").IsRequired();
            Property(p => p.TodayProduced).HasColumnType("int").IsRequired();
