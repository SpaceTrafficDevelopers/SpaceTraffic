...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver();
        this.alertDialogFactory = new AlertDialogFactory(this, this.sounds);
    ...
    public void nextQuestion(View v){
        ...
        if(currentQuestion.getRightChoice().getName().compareTo(chooseAnswer) == 0)
    ...
    public void startTimer(){
        ...
        this.timer = new MyCountDownTimer(START_TIME, INTERVAL, this.timerTextView,
                getResources().getString(R.string.remain), new OverTimeLimit(), this.sounds);
        resumeTimer();
    }
